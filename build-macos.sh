...
echo ""
echo "████████████████████████████████████████████████"
echo "   ShieldOS Build Script — macOS"
echo "████████████████████████████████████████████████"
echo ""
...
mkdir -p assets
cp -n "$ROOT_DIR/ui/assets/icon.icns" assets/ 2>/dev/null || true
...
pyinstaller --clean --onefile --noconsole \
    ...
    --icon "$ROOT_DIR/ui/assets/icon.icns" \
...
echo ""
echo "[5/5] Building macOS DMG..."
npm run build:mac

echo ""
echo "████████████████████████████████████████████████"
echo "   BUILD COMPLETE"
echo "   DMG: ui/dist/ShieldOS.dmg"
echo "████████████████████████████████████████████████"
echo ""
